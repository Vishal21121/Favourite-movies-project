...
window.addEventListener('load', async (event) => {
    ...
    val.results.forEach(element => {
        ...
        <div class="relative top-[37px]" id = ${i++}>
            <span
                class="inline-block w-auto bg-gray-300 p-1 rounded-md mx-2 text-xs text-black font-semibold hover:bg-gray-400 hover:cursor-pointer">Year: ${element['release_date']}
            </span>
            <span
                class="inline-block w-auto bg-gray-300 p-1 rounded-md mx-2 text-xs text-black font-semibold hover:bg-gray-400 hover:cursor-pointer">Rank:${element['popularity']}
            </span>
            <button
